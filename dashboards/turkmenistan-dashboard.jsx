      ...
      <div className="dash">
        ...
        {(() => {
          ...
          const tiles = [
            ...
            { icon: fasvg('0 0 448 512', 'M0 80L0 229.5c0 17 6.7 33.3 18.7 45.3l176 176c25 25 65.5 25 90.5 0L418.7 317.3c25-25 25-65.5 0-90.5l-176-176c-12-12-28.3-18.7-45.3-18.7L48 32C21.5 32 0 53.5 0 80zm112 32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z'), label: 'Inflation', value: '~3.8%', note: '2024 official; real likely higher' },
        ...
        <div className="row g-1 mb-3">
          ...
          <div className="col-6 col-md-4 d-flex"><KpiCard label="Fertility Rate" value="~2.5" sub="Above replacement; declining from 3+ in 1990s (UN WPP 2024)" accent={C.blu} delay={0.30} /></div>
        </div>
        ...
        <div className="row g-1 mb-3">
          ...
          <div className="col-6 col-md-4 d-flex"><KpiCard label="HDI (2023)" value="0.745" sub="High Human Development — rank 97th globally (UNDP 2023)" accent={C.dim} delay={0.10} /></div>
        ...
        <div className="row g-1 mb-3">
          ...
          <div className="col-6 col-md-4 d-flex"><KpiCard label="HDI (2023)" value="0.745 (rank 97)" sub="UNDP; 'High Human Development'; driven by income metric — other indicators lower" accent={C.dim} delay={0.10} /></div>
